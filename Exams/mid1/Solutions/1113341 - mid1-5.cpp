...
void HugeInteger< T >::operator-=( HugeInteger &op2 )
{
    ...
    typename vector<T>::iterator it = integer.begin(), it2 = op2.integer.begin();
    typename vector<T>::iterator itDif = difference.integer.begin();

    for (; it2 < op2.integer.end(); it2++, itDif++)
    {
        *(itDif) -= *(it2);
    }
  ...
  /*  for (size_type i = 0; i < op2.integer.size(); i++)
    ...
    for (size_type i = 0; i < difference.integer.size() - 1; i++)
    {
    ...
    /*while (difference.integer.size() != 1 && difference.integer[difference.integer.size() - 1] == 0)
    {
        difference.integer.pop_back();
    }*/
...
void HugeInteger< T >::operator*=( HugeInteger &op2 )
{
    ...
    for (size_t i = 0; i < op2.integer.size(); i++)
    {
        ...
        {
            product.integer[i + j] += integer[j] * op2.integer[i];
        }
    }

    for (size_t i = 0; i < product.integer.size() - 1; i++)
    {
    ...
    /*while (product.integer[product.integer.size() - 1] == 0)
    {
        product.integer.pop_back();
    }*/
    /*cout << endl << product.integer.size() << "  " << product << endl;*/
    while (product.leadingZero())
    {
        product.integer.pop_back();
        /*cout << endl << product.integer.back() << endl;
        cout << endl << product.integer.size() << "  " << product << endl;*/
    }
...
HugeInteger< T > HugeInteger< T >::operator/( HugeInteger &op2 )
{
    ...
    for (int i = buffer.integer.size() - 1, j = op2.integer.size() - 1; j >= 0; i--, j--)
    {
        buffer.integer[i] = op2.integer[j];
    }
...
HugeInteger< T > HugeInteger< T >::operator%( HugeInteger &op2 )
{
    HugeInteger remainder = ( *this ) / op2;
    //cout << "\na\n";
    remainder *= op2;
    //cout << "\nb\n";
    remainder -= ( *this );
...
{
    int t1 = 0, a1 = 0, b1 = 0;
    long int t2 = 0, a2 = 0, b2 = 0;
    long long int t3 = 0, a3 = 0, b3 = 0;
