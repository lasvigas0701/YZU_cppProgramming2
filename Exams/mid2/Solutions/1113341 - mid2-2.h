...
public:
   ...
   void resize( size_type newSize )
   {
      if( myData.mySize < newSize ) // pad to make larger
      {
          ...
          iterator it = myData.myHead->prev; /*the last node*/
          for (; diff--; it++)
          {
              it.ptr->next = new node;
              it.ptr->next->myVal = Ty();
      ...
      else
      {
          ...
          iterator it = myData.myHead->prev, itBuf = it.ptr->prev;
          for (; diff--; it = itBuf, itBuf--)
          {
   ...
   void clear() // erase all
   {
      ...
      {
          iterator it = begin(), itBuf = it.ptr->next;
          for (; it != end(); it = itBuf, itBuf++)
          {
              it.ptr->prev->next = it.ptr->next;
              it.ptr->next->prev = it.ptr->prev;
              delete it.ptr;
