...
bool equal( vector &vector1, std::vector< int > &vector2 )
{
    if (vector1.capacity() != vector2.capacity()) {
        /*cout << "vc1: " << vector1.capacity();
        cout << "\tvc2: " << vector2.capacity() << endl;*/
         return false;
    }
        

    if (vector1.size() != vector2.size()) {
        /*cout << "vs1: " << vector1.size();
        cout << "\tvs2: " << vector2.size() << endl;*/
        return false;
    }    
    ...
    for (size_t i = 0; i < vector2.size(); ++i) {
        if (first1[i] != first2[i]) {
            /*cout << i << "\terror: first1: " << first1[i];
            cout << "\tfirst2: " << first2[i] << endl;*/
            return false;
        }
        /*cout << i << " : first1: " << first1[i];
        cout << "\tfirst2: " << first2[i] << endl;*/
    }
