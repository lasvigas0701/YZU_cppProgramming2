...
void testInsert1()
{
    ...
    for( int i = 0; i < number; i++ )
    {
        ...
        for( int s = 0; s <= c; s++ )
        {
           ...
           /* cout << "s1: ";
            for (unsigned int i = 0; i < string2.length(); i++) {
                cout << string1.at(i);
            }
            cout << "   s2: ";
            for (unsigned int i = 0; i < string2.length(); i++) {
...
bool equal( string &string1, std::string &string2 )
{
    if (string1.capacity() != string2.capacity()) {
        cout << "s1c: " << string1.capacity() << "  s2c: " << string2.capacity() << endl;
        return false;
    }

    if (string1.size() != string2.size())
    {
        cout << "s1s: " << string1.size() << "  s2s: " << string2.size() << endl;
        return false;
    }
    ...
    for( size_t i = 0; i <= string2.size(); i++ )
        ...
        {
            cout << i << "  s1at: " << string1.at(i) << "  s2at: " << string2[i] << endl;
            /*exit(1);*/
            return false;
        }
