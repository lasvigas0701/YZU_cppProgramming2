...
public:
    ...
    Polynomial compSquareRoot()
    {
        ...
        /*cannot because when line 194 execute, divisor.polynomial.begin() will new a memeory
        typename vector<T1>::iterator divBeg = divisor.polynomial.begin();*/
        
        /*can because when line 196 execute, remainder'size must <= buffer's, memeory won't new*/
